   ...
   <div class="border-b border-gray-900/10 pb-12">
     ...
     <div class="mt-10 col-span-full gap-y-8">
      <label for="id_user" class="block text-sm/6 font-medium text-gray-900">Id User</label>
        <div class="mt-2">
          <input id="id_user" name="id_user" type="number" autocomplete="id_user" value="{{ old('id_user') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
        </div>
    </div>
